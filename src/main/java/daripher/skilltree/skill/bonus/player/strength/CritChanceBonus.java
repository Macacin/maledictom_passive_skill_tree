...
public final class CritChanceBonus implements SkillBonus<CritChanceBonus> {
    ...
    public CritChanceBonus(float chance, AttributeModifier.Operation operation) {
        this.chance = chance;
    ...
    public SkillBonus.Serializer getSerializer() {
        return PSTSkillBonuses.CRIT_CHANCE_STRENGTH.get();
    }

    @Override
    public CritChanceBonus copy() {
        return new CritChanceBonus(chance, operation);
    }
    ...
    public SkillBonus<CritChanceBonus> merge(SkillBonus<?> other) {
        ...
        return new CritChanceBonus(mergedChance, this.operation);
    }

    @Override
    public MutableComponent getTooltip() {
        return TooltipHelper.getSkillBonusTooltip("crit_chance", chance, operation).withStyle(TooltipHelper.getSkillBonusStyle(isPositive()));
    }
    ...
    private void setChance(Consumer<CritChanceBonus> consumer, float value) {
        chance = value;
        consumer.accept(this.copy());
    }

    private void setOperation(Consumer<CritChanceBonus> consumer, AttributeModifier.Operation operation) {
        this.operation = operation;
        consumer.accept(this.copy());
    }
    ...
    public static class Serializer implements SkillBonus.Serializer {
        ...
        public void serialize(JsonObject json, SkillBonus<?> bonus) {
            if (!(bonus instanceof CritChanceBonus cBonus)) {
                throw new IllegalArgumentException();
            }
            json.addProperty("chance", cBonus.chance);
        ...
        public CompoundTag serialize(SkillBonus<?> bonus) {
            ...
            tag.putFloat("chance", cBonus.chance);
        ...
        public void serialize(FriendlyByteBuf buf, SkillBonus<?> bonus) {
            ...
            buf.writeFloat(cBonus.chance);
            buf.writeInt(cBonus.operation.toValue());
        }

        @Override
        public SkillBonus<?> createDefaultInstance() {
            return new CritChanceBonus(0.1f, AttributeModifier.Operation.ADDITION);
        }
    }
}