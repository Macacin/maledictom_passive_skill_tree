...
public final class CritDamageBonus implements SkillBonus<CritDamageBonus> {
    ...
    public CritDamageBonus(float bonus, AttributeModifier.Operation operation) {
        this.bonus = bonus;
    ...
    public SkillBonus.Serializer getSerializer() {
        return PSTSkillBonuses.CRIT_DAMAGE_STRENGTH.get();
    }

    @Override
    public CritDamageBonus copy() {
        return new CritDamageBonus(bonus, operation);
    }
    ...
    public SkillBonus<CritDamageBonus> merge(SkillBonus<?> other) {
        ...
        return new CritDamageBonus(mergedBonus, this.operation);
    }

    @Override
    public MutableComponent getTooltip() {
        return TooltipHelper.getSkillBonusTooltip("crit_damage", bonus, operation).withStyle(TooltipHelper.getSkillBonusStyle(isPositive()));
    }
    ...
    private void setBonus(Consumer<CritDamageBonus> consumer, float value) {
        bonus = value;
        consumer.accept(this.copy());
    }

    private void setOperation(Consumer<CritDamageBonus> consumer, AttributeModifier.Operation operation) {
        this.operation = operation;
        consumer.accept(this.copy());
    }
    ...
    public static class Serializer implements SkillBonus.Serializer {
        ...
        public void serialize(JsonObject json, SkillBonus<?> bonus) {
            if (!(bonus instanceof CritDamageBonus cBonus)) {
                throw new IllegalArgumentException();
            }
        ...
        public SkillBonus<?> createDefaultInstance() {
            return new CritDamageBonus(0.1f, AttributeModifier.Operation.ADDITION);
        }
    }
}